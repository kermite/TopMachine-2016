...
namespace TopMachine.Topping.Engine.GameController.RoundManager
{
    ...
    /// </summary>
    public class CTrainingRoundManager : CRoundManager
    {
        ...
        public CTrainingRoundManager(GameControllers gctls, GameCfg cfg)
            : base(gctls, cfg)
        {
            if (cfg.Config.Name.Contains("TRAINING"))
            {
                dico = TopMachine.Topping.Dawg.DicoUtils.Instance.GetDico("FRTRAINING");
                maxTurn = 100;
            }
        }
